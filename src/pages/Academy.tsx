...
const TRACKS = [
  ...
  },
  {
    level: 4,
    title: "سيد الظلال",
    role: "مهندس عمليات الظلال",
    desc: "المستوى الأعلى من الوجود الرقمي. التخفي، العمليات في الذاكرة، وبقاء الأنظمة المتقدم.",
    topics: ["عمليات الظل", "بناء أدوات مخصصة", "آليات البقاء المتقدمة", "الحرب التشفيرية"],
  }
];
